...
class ActivityRequirementDto with _$ActivityRequirementDto {
  ...
  factory ActivityRequirementDto.fromDomain(ActivityRequirement requirement) {
    return ActivityRequirementDto(
        ...
        customRequirementOption: requirement.customRequirementOption?.value.fold((l) => [], (r) => r.map((e) => DetailCustomRuleOptionDto.fromDomain(e).toJson()).toList()),
  ...
  ActivityRequirement toDomain() {
    return ActivityRequirement(
        ...
        customRequirementOption: ListK(customRequirementOption?.map((e) => DetailCustomRuleOptionDto.fromJson(e).toDomain()).toList() ?? []),
