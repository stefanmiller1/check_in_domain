...
class AttendeeItemDto with _$AttendeeItemDto {
  ...
  factory AttendeeItemDto.fromDomain(AttendeeItem attendeeItem) {
    return AttendeeItemDto(
        ...
        vendorForm: (attendeeItem.vendorForm != null) ? VendorMerchantFormDto.fromDomain(attendeeItem.vendorForm!).toJson() : null,
        ...
        checkInSetting: (attendeeItem.checkInSetting != null && attendeeItem.checkInSetting?.isNotEmpty == true) ? attendeeItem.checkInSetting!.map((e) => CheckInSettingsDto.fromDomain(e).toJson()).toList() : null,
        customFieldRuleSetting: (attendeeItem.customFieldRuleSetting != null && attendeeItem.customFieldRuleSetting?.isNotEmpty == true) ? attendeeItem.customFieldRuleSetting!.map((e) => CustomRuleOptionDto.fromDomain(e).toJson()).toList() : null,
        classesInstructorProfile: (attendeeItem.classesInstructorProfile != null) ? attendeeItem.classesInstructorProfile!.getOrCrash() : null,
        eventMerchantVendorProfile: (attendeeItem.eventMerchantVendorProfile != null) ? attendeeItem.eventMerchantVendorProfile!.getOrCrash() : null,
  ...
  AttendeeItem toDomain() {
    return AttendeeItem(
        ...
        vendorForm: (vendorForm != null) ? VendorMerchantFormDto.fromJson(vendorForm!).toDomain() : null,
        ...
        checkInSetting: (checkInSetting != null && checkInSetting?.isNotEmpty == true) ? checkInSetting!.map((e) => CheckInSettingsDto.fromJson(e).toDomain()).toList() : null,
        customFieldRuleSetting: (customFieldRuleSetting != null && customFieldRuleSetting?.isNotEmpty == true) ? customFieldRuleSetting!.map((e) => CustomRuleOptionDto.fromJson(e).toDomain()).toList() : null,
        classesInstructorProfile: (classesInstructorProfile != null) ? UniqueId.fromUniqueString(classesInstructorProfile!) : null,
        eventMerchantVendorProfile: (eventMerchantVendorProfile != null) ? UniqueId.fromUniqueString(eventMerchantVendorProfile!) : null,
